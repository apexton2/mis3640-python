...
if n is divisible by 100 (for example, 1900); the only exception 
is when n is divisible by 400(for example, 2000), return True.
"""
...
#     Return False if n is divisible by 100 (for example, 300); the only exception is when n 
#     is divisible by 400(for example, 2400), return True.
#     """
#     pass
...
-----------------------------------------------------------------------
Question 3:
Write a function with loops that computes the sum of all cubes of all 
the odd numbers between 1(inclusive) and n (inclusive if n is not even).
"""
